...
发送邮件可能随机出现卡死，目前原因未知，点[这里](https://github.com/zeruniverse/QQParking/releases/tag/2.0)可以下载不带邮件功能的版本。  
...
+ 如果需要不带邮件提示功能的版本，请下载这个: https://github.com/zeruniverse/QQParking/releases/tag/2.0  
